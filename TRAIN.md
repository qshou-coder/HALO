...
1. **Download the sample dataset**
   ...
   ```bash
   # TODO: replace <DATASET_URL> with the public mirror of bagel_example.zip
   wget -O bagel_example.zip <DATASET_URL>
...
| Argument                    | Default                     | Description                                               |
| --------------------------- | --------------------------- | --------------------------------------------------------- |
| `dataset_config_file`       | `data/configs/robotwin.yaml` | YAML that groups datasets and assigns sampling weights.   |
